...
public:
     ...
     *        over the effective conductivity field
     * \param psiIdx The index/dimension of the cell problem (0 or 1)
     * \param derivIdx The index/dimension of the partial derivative (0 or 1)
     */
     ...
     * \note  \f$ (\Phi*k_s + (1-\Phi)*kg_)*(\delta_{ij} + \partial y_i \Psi^{j}) \f$.
     * \param psiIdx The index/dimension of the cell problem (0 or 1) = j
