 ...
 * \brief Quantities required by the one-phase fully implicit model defined on a vertex. Copy of OnePModel, inherits from MyEnergyVolumeVariables
 */
...
, public MyEnergyVolumeVariables<Traits, MyOnePVolumeVariables<Traits> >
{
    ...
    using EnergyVolVars = MyEnergyVolumeVariables<Traits, MyOnePVolumeVariables<Traits> >;
